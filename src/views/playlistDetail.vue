      ...
      <div v-if="playlist" class="text-white h-full p-2">
        ...
        <div class="flex flex-col space-y-6 w-full h-full p-3">
          ...
          <div class="flex flex-wrap items-end gap-6">
            <!-- Image de couverture -->
            <div class="w-48 h-48 bg-gradient-to-br from-[var(--main-color)]/30 to-purple-500/30 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div class="flex-1 space-y-4">
              ...
              <div class="flex items-center space-x-4">
                <button 
                  ...
                  :class="`flex space-x-1 items-center justify-center bg-[var(--main-color)] text-white disabled:bg-zinc-600 disabled:cursor-not-allowed text-[0.7em] p-1 px-6 transition-all rounded-md cursor-pointer`"
                >
                ...
                <button 
                  ...
                  :disabled="playlist.tracks.length === 0"
                  class="flex space-x-1 items-center justify-center bg-white/10 hover:bg-white/20 disabled:bg-zinc-600 disabled:cursor-not-allowed text-[0.7em] p-1 px-6 transition-all rounded-md cursor-pointer"
                >
          ...
          <div class="flex-1 overflow-auto p-1 scrollBar">
            <div v-if="playlist.tracks.length === 0" class="text-center py-12">
              <div class="text-white/80 mb-4">
                ...
                <button 
                  @click="addMusicToPlaylist"
                  class="bg-[var(--main-color)] hover:bg-[var(--main-color)]/80 px-4 py-2 rounded-md text-sm font-semibold transition-colors"
                >
            ...
            <div v-else class="space-y-1">
              ...
              <div 
                ...
                :class="`flex items-center space-x-4 px-4 py-1 rounded-lg cursor-pointer transition-all group text-[0.76em] font-light ${index%2 == 0 ? `bg-white/10` : `bg-transparent`} ${isActiveTrack(track) ? 'bg-[var(--main-color)]/30 border-2 border-[var(--main-color)]/40' : ''}`"
              >
                ...
                <div class="w-8 flex justify-center">
                  ...
                  <div v-if="isActiveTrack(track)" class="text-[var(--main-color)]">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 bg-zinc-800 rounded flex-shrink-0 overflow-hidden">
                      <img v-if="track.cover" :src="track.cover" :alt="track.title" class="w-full h-full object-cover">
                    </div>
                    <div class="min-w-0 flex-1">
                      <p :class="`font-semibold truncate ${isActiveTrack(track) ? 'text-[var(--main-color)]/80' : 'text-white'}`">
                        {{ track.title }}
                      </p>
            ...
            <div class="space-y-4">
              <div>
                ...
                <input 
                  v-model="editName"
                  type="text" 
                  class="w-full bg-zinc-700 border border-zinc-600 rounded-lg px-3 py-2 focus:outline-none focus:border-cyan-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows="3"
                  class="w-full bg-zinc-700 border border-zinc-600 rounded-lg px-3 py-2 focus:outline-none focus:border-cyan-500 resize-none"
                ></textarea>
              </div>
            </div>
        ...
        <div v-if="showAddMusicModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-2" @click.self="showAddMusicModal = false">
          <div class="bg-zinc-800 rounded-lg p-4 max-w-2xl w-[80%] max-h-[90%] flex flex-col">
            ...
            <div class="mb-4">
              <input 
                ...
                class="w-full h-8 bg-zinc-700 border border-zinc-600 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[var(--main-color)]"
              />
            </div>
            ...
            <div class="flex-1 overflow-auto scrollBar space-y-1">
              ...
              >
                <div class="flex items-center space-x-3 flex-1 min-w-0">
                  <div class="w-10 h-10 bg-zinc-700 rounded flex-shrink-0 overflow-hidden">
                    <img v-if="track.cover" :src="track.cover" :alt="track.title" class="w-full h-full object-cover">
                  </div>
                  <div class="min-w-0 flex-1">
                ...
                <button 
                  ...
                  :class="`p-1 text-sm rounded-lg transition-colors ${
                    isTrackInCurrentPlaylist(track.id) 
                      ...
                      : 'bg-[var(--main-color)] hover:bg-[var(--main-color)]/80'
                  }`"
                >

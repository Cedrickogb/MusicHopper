<template>
    <div class="relative text-white w-full h-full p-2 overflow-hidden">
      <div 
        ...
        class="flex flex-col space-y-2 w-full h-full p-3"
      >
          ...
          <div class="flex flex-col w-full text-xl space-y-3">
              ...
              <div :class="`relative flex w-[50%] bg-white/10 space-x-2 text-base rounded-md p-2 px-4 justify-between items-center border border-white/20`">
                  ...
                  <div class="flex space-x-2 justify-center items-center">
                      <span :class="`bg-[var(--main-color)] text-white text-sm p-1 px-3 rounded-md cursor-pointer`" @click="selectFolder()">Add a folder</span>
                      <span :class="`flex`">
